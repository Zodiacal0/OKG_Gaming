...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="${pageContext.request.contextPath}/resources/assets/img/index/icon/OkG shop v4.png">
            ...
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none"
                        href="mailto:okgsupport@gmail.com">okgsupport@gmail.com</a>
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid"
                            src="${pageContext.request.contextPath}/resources/assets/img/tienda/Catalogo_Play_Station/catalogo_playsation_game3.png"
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Horizon Zero Dawn</h1>
                            <p class="h3 py-2">$49.99</p>
                            <p class="py-2">
                                ...
                                <span class="list-inline-item text-dark">Rating 4.5 | 200 Comentarios</span>
                            </p>
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Guerrilla Games</strong></p>
                                </li>
                            </ul>

                            <h6>Descripción:</h6>
                            <p>En Horizon Zero Dawn, los jugadores asumen el rol de Aloy, una joven cazadora en un mundo
                                postapocalíptico dominado por máquinas. Explora vastos y bellos paisajes mientras
                                descubres misterios antiguos y enfrentas amenazas mecánicas. Con su narrativa
                                cautivadora, gráficos impresionantes y un sistema de combate profundo, este juego ofrece
                            ...
                            <ul class="list-unstyled pb-3">
                                <li>Plataforma: PlayStation 4</li>
                                <li>Desarrollador: Guerrilla Games</li>
                                <li>Género: Acción/RPG</li>
                                <li>Lanzamiento: 28 de febrero de 2017</li>
                                <li>Gráficos: Resolución 4K, soporte para HDR</li>
                                <li>Requisitos del Sistema: PlayStation 4 Console</li>
                                <li>Idiomas: Variados (incluye soporte para múltiples idiomas)</li>
                            </ul>

                            <form action="" method="GET">
                                <input type="hidden" name="product-title" value="Horizon Zero Dawn">
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            ...
                                            <li class="list-inline-item"><span
                                                    class="btn btn-success btn-size">Standard</span></li>
                                        </ul>
                                    </div>
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
        ...
        <div class="container">
            ...
            <div class="row text-light mb-4">
                ...
                <div class="col-auto">
                    ...
                    <div class="input-group mb-2">
                        <input type="text" class="form-control subscribe-email border-light" id="subscribeEmail"
                ...
                <div class="row pt-2">
                    <div class="col-12">
                        <p class="text-left text-light">
                            ...
                            | Designed by <a class="text-developer" rel="sponsored" href="#" target="_blank">OKG
                                Corporation</a>
                        </p>
                    </div>
                </div>
