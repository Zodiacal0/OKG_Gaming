        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/tienda/Catalogo_Play_Station/catalogo_playstation_game4.png" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Spiderman Miles Morales</h1>
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item">
                        <p class="text-muted"><strong>PlayStation</strong></p>
                    </li>
                </ul>

                <h6>Description:</h6>
                <p>¡Descubre la vida de un superhéroe en Spider-Man: Miles Morales! Salta entre rascacielos, derrota a villanos y domina tus poderes arácnidos en esta emocionante aventura. Conviértete en el próximo Spider-Man mientras explores el vibrante mundo de Nueva York, personaliza tu equipamiento y enfréntate a una amenaza que pone en peligro a la ciudad. Con una cautivadora narrativa y una acción trepidante, este juego es imprescindible para los fanáticos de los superhéroes. ¡No te lo puedes perder!               </p>
                <ul class="list-inline">
                    <li class="list-inline-item">
                        <h6>Versiones Disponibles</h6>
                    </li>
                    <li class="list-inline-item">
                        <p class="text-muted"><strong>Standard / Deluxe</strong></p>
                    </li>
                    <li class="list-inline-item">
                        <p class="text-muted"><strong>Dekuxe</strong></p>
                    </li>
                </ul>

                <h6>Specification:</h6>
                <ul class="list-unstyled pb-3">
                    <li>Plataforma: Play Station</li>
                    <li>Desarrollador: Insomniac Games</li>
                    <li>Género: Acción/aventura</li>
                    <li>Lanzamiento: 12 de noviuembre de 2020</li>
                    <li>Gráficos: Resolución nativa 4K en PlayStation</li>
                    <li>Requisitos del Sistema: PlayStation 4, PlayStation 5</li>
