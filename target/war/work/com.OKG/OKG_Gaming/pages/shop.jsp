...
<body>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="row" action="JuegosServlet" method="GET" id="dynamic-content">
    ...
    <script src="${pageContext.request.contextPath}/resources/assets/js/bootstrap.css"></script>
    <script src="${pageContext.request.contextPath}/resources/assets/js/templatemo.js"></script>
    <script src="${pageContext.request.contextPath}/resources/assets/js/custom.js"></script>
    <script>
        $(document).ready(function() {
            loadContent('JuegosServlet');
        });
    
        function loadContent(servletUrl) {
            $.ajax({
