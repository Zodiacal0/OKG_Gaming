<%-- 
    Document   : index
    Created on : 18-jul-2024, 18:18:25
    Author     : Javier
--%>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                ...
                <p class="text-center"><a href="#" class="btn btn-success">Ver más</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">Halo Infinite</a>
                            <p class="card-text">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">The Legend of Zelda: Tears of the Kingdom</a>
                            <p class="card-text">
                                Explora el vasto mundo abierto de Hyrule en The Legend of Zelda: Tears of the Kingdom. Únete a Link en su épica aventura para rescatar a la princesa Zelda y derrotar al malvado Ganon. Con gráficos impresionantes y una jugabilidad innovadora, este juego es una obra maestra.
                            </p>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="shop-single.html" class="h2 text-decoration-none text-dark">Spider-Man 2</a>
                            <p class="card-text">
