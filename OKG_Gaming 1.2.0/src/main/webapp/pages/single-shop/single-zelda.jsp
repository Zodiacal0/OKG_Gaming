        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/tienda/Catalogo_Nintendo/catalogo_nintendo_game2.png" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">The legend of zelda tears-of the kingdom</h1>
                            ...
                            <h6>Description:</h6>
                            <p>Sumergete en una aventura magica con The Legend of Zelda: Tears of the Kingdom para Nintendo Switch. Acompana a Link en su epico viaje para restaurar el equilibrio en el mundo de Hyrule. Explora un vasto reino lleno de misterios, peligros y desafios mientras desentranas la historia detras de las lagrimas del reino. Con una jugabilidad envolvente, un mundo expansivo y un estilo visual impresionante, este titulo ofrece una experiencia inolvidable para los fans de Zelda y los nuevos jugadores por igual. ¡No te pierdas esta emocionante adicion a la aclamada serie de Zelda!</p>
                            ...
                            <ul class="list-unstyled pb-3">
                                ...
                                <li>Lanzamiento: 12 de mayo de 2023</li>
