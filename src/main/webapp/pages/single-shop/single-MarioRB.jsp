        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/tienda/Catalogo_Nintendo/catalogo_nintendo_game3.png" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Mario + Rabbids: Sparks of Hope</h1>
                <p class="h3 py-2">$21.99</p>
                <p class="py-2">
                ...
                <h6>Description:</h6>
                <p>Sumergente en una aventura divertida con Mario + Rabbids: Sparks of Hope para Nintendo Switch. Acompaña a Mario y sus amigos en una emocionante aventura por el espacio para detener una amenaza que pone en peligro a todo el universo. Explora mundos coloridos, enfréntate a enemigos desafiantes y utiliza una mezcla de habilidades estratégicas y ataques especiales para superar los obstáculos. Con gráficos vibrantes, una jugabilidad entretenida y una historia cautivadora, este título es perfecto para los fans de Mario y los nuevos jugadores por igual. ¡No te pierdas esta emocionante adición a la saga de Mario + Rabbids!</p>
                ...
                <ul class="list-inline">
                    ...
                    <li class="list-inline-item">
                        <p class="text-muted"><strong>Cosmic</strong></p>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled pb-3">
                    ...
                    <li>Género: Estrategia/Aventura</li>
                    <li>Lanzamiento: 20 de octubre de 2022</li>
                    <li>Gráficos: Resolución HD, soporte para 720p en modo portátil y hasta 1080p en modo acoplado</li>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            ...
                                            <li class="list-inline-item"><span class="btn btn-success btn-size">Cosmic</span></li>
                                        </ul>
                                    </div>
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
