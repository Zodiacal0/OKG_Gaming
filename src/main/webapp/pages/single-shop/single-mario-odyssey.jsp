        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/tienda/Catalogo_Nintendo/catalogo_nintendo_game1.png" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Mario Odyssey</h1>
                            <p class="h3 py-2">$19.99</p>
                            <p class="py-2">
                                ...
                                <span class="list-inline-item text-dark">Rating 3.7 | 23 Comments</span>
                            </p>
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Nintendo</strong></p>
                                </li>
                            </ul>

                            <h6>Description:</h6>
                            <p>Embarcate en una aventura épica con Super Mario Odyssey para Nintendo Switch. Acompaña a Mario en su viaje global para rescatar a la Princesa Peach de las garras de Bowser, que planea casarse con ella. Explora mundos vibrantes y únicos llenos de desafíos, enemigos y secretos mientras utilizas el poderoso sombrero de Mario, Cappy, para tomar el control de objetos y enemigos. Con graficos deslumbrantes, una jugabilidad innovadora y un mundo abierto expansivo, Mario Odyssey ofrece una experiencia de juego envolvente y divertida para todas las edades. ¡No te pierdas esta aclamada entrega en la saga de Mario!</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Versiones Disponibles</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Standar</strong></p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-unstyled pb-3">
                                ...
                                <li>Género: Accio                                <li>Género: Accion/Aventura</li>n/Aventura</li>
                                <li>Lanzamiento: 27 de octubre de 2017</li>
                                <li>Graficos: Resolucio                                <li>Graficos: Resolucion HD, soporte para 720p en modo portatil y hasta 1080p en modo acoplado.</li>n HD, soporte para 720p en modo portatil y hasta 1080p en modo acoplado.</li>
                                <li>Requisitos del Sistema: Nintendo Switch Console</li>
                                <li>Idiomas: Variados (incluye soporte para múltiples idiomas)</li>
                            </ul>
                                ...
                                <div class="row">
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            ...
                                            <li class="list-inline-item"><span class="btn btn-success btn-size">Estandar</span></li>
                                        </ul>
                                    </div>
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
    ...
    <footer class="bg-dark" id="tempaltemo_footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 pt-5">
                    <h2 class="h2 text-light border-bottom pb-3 border-light">Informacio                    <h2 class="h2 text-light border-bottom pb-3 border-light">Informacion</h2>n</h2>
                    <ul class="list-unstyled text-light footer-link-list">
