        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/tienda/Catalogo_Nintendo/catalogo_nintendo_game5.png" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <h1 class="h2">Mario Kart 8 Deluxe</h1>
...
<h6>Description:</h6>
<p>Unete a la carrera con Mario Kart 8 Deluxe para Nintendo Switch. Vive la emocion de las carreras de karts con tus personajes favoritos de Mario en esta version mejorada del clasico juego. Disfruta de nuevos modos de juego, pistas vibrantes y una amplia variedad de karts y accesorios. Compite en emocionantes carreras en solitario o con amigos y familia en el modo multijugador. Con graficos mejorados y una jugabilidad adictiva, Mario Kart 8 Deluxe es una experiencia de carreras definitiva para los fans de Mario y los nuevos jugadores por igual. ¡No te pierdas esta emocionante adicion a la serie de Mario Kart!</p>
...
<ul class="list-inline">
    ...
    <li class="list-inline-item">
        <p class="text-muted"><strong>Deluxe</strong></p>
    </li>
</ul>
...
<ul class="list-unstyled pb-3">
    ...
    <li>Genero: Carreras/Arcade</li>
    <li>Lanzamiento: 28 de abril de 2017</li>
...
<form action="" method="GET">
    <input type="hidden" name="product-title" value="Mario Kart 8 Deluxe">
    <div class="row">
        <div class="col-auto">
            <ul class="list-inline pb-3">
                ...
                <li class="list-inline-item"><span class="btn btn-success btn-size">Deluxe</span></li>
            </ul>
        </div>
        <div class="col-auto">
            <ul class="list-inline pb-3">
