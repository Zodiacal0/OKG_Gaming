        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/tienda/Catalogo_Play_Station/catalogo_playstation_game2.png" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">The Last of Us 2 Remastered</h1>
<p class="h3 py-2">$59.99</p>
<p class="py-2">
...
<ul class="list-inline">
    ...
    <li class="list-inline-item">
        <p class="text-muted"><strong>Naughty Dog</strong></p>
    </li>
</ul>

<h6>Description:</h6>
<p>Sumergente en una aventura intensa con The Last of Us 2 Remastered. Vive la historia de Ellie en un mundo post-apocaliptico lleno de emociones y decisiones dificiles. Explora paisajes detallados, enfrenta a enemigos implacables y experimenta una narrativa profunda que explora temas de venganza y redencion. Con graficos mejorados y una jugabilidad refinada, esta edicion remasterizada ofrece una experiencia mejorada para los fanáticos de la serie y nuevos jugadores. ¡No te pierdas esta emocionante remasterizacion de un clasico moderno!</p>
...
<ul class="list-unstyled pb-3">
    ...
    <li>Desarrollador: Naughty Dog</li>
    <li>Genero: Accion/Aventura</li>
    <li>Lanzamiento: 19 de enero de 2023</li>
...
<form action="" method="GET">
    <input type="hidden" name="product-title" value="The Last of Us 2 Remastered">
    <div class="row">
        <div class="col-auto">
