        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="${pageContext.request.contextPath}/resources/assets/img/tienda/Catalogo_Nintendo/catalogo_nintendo_game4.png" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">Sonic Superstars</h1>
                ...
                <h6>Description:</h6>
                <p>Sonic Superstars es un videojuego de plataformas de 2023 desarrollado por Arzest y Sonic Team, y publicado por Sega. El juego sigue las aventuras de Sonic y sus amigos en una nueva aventura en la Isla Norte.</p>
                ...
                <ul class="list-unstyled pb-3">
                    ...
                    <li>Desarrollador: Sega</li>
                    <li>Género: Estrategia/Aventura</li>
                    <li>Lanzamiento: 17 de octubre de 2023</li>
