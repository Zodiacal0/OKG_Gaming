...
<body>
    ...
    <div class="container-fluid bg-light py-5">
        <div class="col-md-6 m-auto text-center">
            ...
            <p>
                Para mas informacion contactanos al  +502 5588 5335, si te ha gustado nustros productos tienes una duda o alguna queja
                puedes visitar nuestro sitio web okgsupport@gmail.com
            </p>
        </div>
    </div>
